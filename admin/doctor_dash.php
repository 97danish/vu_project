                        ...
                        <ul>
                            <li>
                                <div class="dash-book dash-b-1">
                                    ...
                                    <a href="doc_profile.php">View more</a>
                                </div>
                            </li>
                            <li>
                            ...
                            <li>
                                <div class="dash-book dash-b-4">
                                    <?php $result = mysqli_query($con, "SELECT * from appointment where app_doc = ".$_SESSION['doctor']['doc_id']."");
                                    $count = mysqli_num_rows($result); ?>
                            ...
                            <li>
                                <div class="dash-book dash-b-4">
                                    ...
                                    <h4><?php echo $_SESSION['doctor']['doc_earning'] ?></h4>
                                    <a href="doc_profile.php">View more</a>
                                </div>
                            </li>
                            <li>
                                <div class="dash-book dash-b-4">
                                    <h5></h5>
                                    <h4>Profile</h4>
                                    <a href="doc_profile.php">Update</a>
                                </div>
                            </li>
                        </ul>
                    </div>
